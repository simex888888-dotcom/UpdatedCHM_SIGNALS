...
class Config:
    ...
    # ════════════════════════════════════════════════
    CACHE_TTL = {
        "1m": 55, "5m": 270, "15m": 870, "30m": 1770,
        "1h": 3570, "4h": 14370, "1d": 85000,
        "1D": 85000, "1H": 3570, "4H": 14370,
    }
    ...
    # Только БОТ (месячный план удалён)
    BOT_PRICE_90  = "180$"
    BOT_PRICE_365 = "400$"

    # БОТ + ИНДИКАТОР на TradingView (месячный план удалён)
    FULL_PRICE_90  = "280$"
    FULL_PRICE_365 = "760$"
    ...
    # ════════════════════════════════════════════════
    D_TIMEFRAME = "1h";  D_INTERVAL = 3600;  D_PIVOT = 7
    D_ATR_PERIOD = 14;   D_ATR_MULT = 1.0;   D_MAX_RISK = 1.5
    D_EMA_FAST = 50;     D_EMA_SLOW = 200
    D_RSI_PERIOD = 14;   D_RSI_OB = 65;      D_RSI_OS = 35
    D_VOL_MULT = 1.0;    D_VOL_LEN = 20
    D_LEVEL_AGE = 100;   D_RETEST_BARS = 30; D_COOLDOWN = 5
    D_ZONE_BUF = 0.3;    D_ZONE_PCT = 0.7    # Ширина зоны уровня в % от цены (рекомендуется 0.7%)
    ...
    D_TP1 = 2.0;  D_TP2 = 3.0;  D_TP3 = 4.5
    D_HTF_EMA = 50;      D_MIN_QUALITY = 2;  D_MIN_VOL_USDT = 1_000_000
    D_USE_RSI = True;    D_USE_VOLUME = True
    D_USE_PATTERN = False; D_USE_HTF = False
    D_NOTIFY_SIG = True; D_NOTIFY_BRK = False
